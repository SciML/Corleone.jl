function jackson(grids)
    ...
    grid_cons_l1 = [x₁(tᵢ) ≳ 0.0 for tᵢ in constraint_grid]
    grid_cons_l2 = [x₂(tᵢ) ≳ 0.0 for tᵢ in constraint_grid]
    grid_cons_l3 = [x₃(tᵢ) ≳ 0.0 for tᵢ in constraint_grid]
