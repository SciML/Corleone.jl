function electric_car(grids)
    ...
    @constants begin
        ...
        M = 250.0, [tunable = false]
        g = 9.81, [tunable = false]
        V_alim = 150.0, [tunable = false]
    ...
    grid_cons_u = [x_1(tᵢ) ≲ 150.0 for tᵢ in constraint_grid]
    grid_cons_l = [x_1(tᵢ) ≳ -150.0 for tᵢ in constraint_grid]

    cons = [
        x_3(last(tspan)) ~ 100.0,
        grid_cons_u...,
        grid_cons_l...,
    ]
