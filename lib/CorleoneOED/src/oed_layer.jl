...
```
"""
struct OEDLayerV2{L, S, D, C, DG} <: LuxCore.AbstractLuxContainerLayer{(:layer, :discrete_controls)}
    layer::L
    symbolic_system::S
    discrete_controls::D
...
"""
function _compute_continuous_fisher(oed::OEDLayerV2, traj::Trajectory)
...
"""
function _compute_discrete_fisher(oed::OEDLayerV2, traj::Trajectory, ps, st)
...
"""
    discrete_fisher_information(oed::OEDLayerV2, traj::Trajectory, ps)
...
"""
function discrete_fisher_information(oed::OEDLayerV2, traj::Trajectory, ps)
