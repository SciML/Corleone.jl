...
control = ControlParameter(
    collect(0.0:0.25:11.75), name = :fishing, bounds = (0.0, 1.0)
)
...
oed = OEDLayer{false}(
    ...
    params = [2, 3],
    measurements = [
        ControlParameter(collect(0.0:0.25:11.75), controls = 0.1 * ones(48), bounds = (0.0, 1.0)),
        ControlParameter(collect(0.0:0.25:11.75), controls = 0.15 * ones(48), bounds = (0.0, 1.0)),
    ],
    observed = (u, p, t) -> u[1:2],
)
